...
</br> Nosso modelo teve um bom Recall e Precision, ambos com 95%. Além disso nossa matriz de confusão ficou assim:</br>
|          | Positivo | Negativo |
|----------|----------|----------|
| **Positivo** | 13       | 12       |
| **Negativo** | 14       | 261      | 
</br></br>
O modelo, mediante essas métricas, performou super bem. Porém, obtive certeza ao avaliar o modelo com a acurácia, ***obtendo 91% de acurácia do modelo.***
